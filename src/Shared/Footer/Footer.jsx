...
const Footer = () => {
  return (
    <div className="bg-[#1e2a38] ">
      <div className="mx-10 md:mx-16 lg:mx-24 flex justify-center">
        <footer className="footer py-10 text-white">
          <aside>
            <img src="https://i.ibb.co/QnKWGMN/logo-white-small.png" alt="" />
            <p>
              <span className="font-bold">TalentBazaar.com</span>
              <br />
          ...
          <nav>
            ...
            <a>
              <strong>Hot Line:</strong> +1 (800) 123-4567
            </a>
          </nav>
          <nav>
            <header className="footer-title">Address</header>
            <a>
              123 Beautiful Street,
              <br />
              Dhaka, Bangladesh
            </a>
          </nav>
          <nav>
            <header className="footer-title">Social Media Link</header>
...
//  some contact information, address, etc.
